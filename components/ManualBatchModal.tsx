      ...
      <div className="bg-white w-full max-w-4xl rounded-3xl shadow-2xl overflow-hidden border border-slate-200 flex flex-col max-h-[90vh]">
        <div className="p-6 border-b flex justify-between items-center bg-slate-50">
          <div>
            ...
            <p className="text-xs text-slate-500 font-bold uppercase tracking-widest mt-0.5">Bulk Paste Engine</p>
          </div>
        ...
        <div className="p-8 flex-1 overflow-y-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="flex flex-col gap-4">
            ...
            <textarea
              className="flex-1 min-h-[300px] p-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:ring-0 focus:border-blue-300 transition-all font-mono text-xs leading-relaxed resize-none"
          ...
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className="w-full py-4 bg-blue-600 text-white rounded-2xl font-black text-sm hover:bg-blue-700 disabled:opacity-50 disabled:grayscale transition-all flex items-center justify-center gap-2 shadow-xl shadow-blue-100"
            >
