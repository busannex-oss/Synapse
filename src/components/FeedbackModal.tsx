...
const FeedbackModal: React.FC<FeedbackModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-0 md:p-4 bg-black/20 backdrop-blur-md animate-in fade-in duration-300">
      <div className="bg-white/90 glass w-full h-full md:h-auto md:max-w-lg md:rounded-[2.5rem] shadow-2xl overflow-hidden border-x md:border border-white/40 flex flex-col synapse-shadow animate-in zoom-in-95 duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="flex bg-gray-100 p-1 rounded-xl">
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-xs font-bold transition-all ${
                    type === 'suggestion' ? 'bg-white shadow-sm text-cyan-600' : 'text-gray-400'
                  }`}
                >
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full bg-white border border-gray-200 rounded-2xl px-4 py-3 text-sm focus:ring-2 ring-cyan-500/10 outline-none transition-all"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full bg-white border border-gray-200 rounded-2xl px-4 py-3 text-sm focus:ring-2 ring-cyan-500/10 outline-none transition-all resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-4 bg-cyan-600 text-white rounded-2xl font-black text-sm hover:bg-cyan-700 disabled:opacity-50 transition-all flex items-center justify-center gap-2 synapse-shadow mt-4"
              >
                {isSubmitting ? (
